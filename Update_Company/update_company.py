...
"color:white;")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/sample/Images/edit264.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.city_cmb = QtWidgets.QComboBox(self.frame)
        self.city_cmb.setMinimumSize(QtCore.QSize(200, 30))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.city_cmb.setFont(font)
        self.city_cmb.setStyleSheet("border-radius:3px;\n"
"border:1px solid gray;\n"
"background-color:white;\n"
"color:gray;\n"
"")
        self.city_cmb.setEditable(True)
        self.city_cmb.setMinimumContentsLength(11)
        self.city_cmb.setObjectName("city_cmb")
        self.city_cmb.addItem("")
        self.city_cmb.addItem("")
        self.city_cmb.addItem("")
        self.city_cmb.addItem("")
        self.horizontalLayout_3.addWidget(self.city_cmb)
...
"color:white;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Update Company"))
        self.pushButton_5.setText(_translate("MainWindow", "Update Company"))
        ...
        self.city_cmb.setItemText(0, _translate("MainWindow", "Vadodara"))
        self.city_cmb.setItemText(1, _translate("MainWindow", "Ahmedabad"))
        self.city_cmb.setItemText(2, _translate("MainWindow", "Surat"))
        self.city_cmb.setItemText(3, _translate("MainWindow", "Rajkot"))
