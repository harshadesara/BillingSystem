...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(390, 710, 250, 40))
        self.pushButton_5.setStyleSheet('link rel="stylesheet" type="text/css" href="test.css"')
        font = QtGui.QFont()
...
"color:white;")
        ...
        self.frame = QtWidgets.QFrame(qt_app)
        font = QtGui.QFont()
        font.setPointSize(11)
...
"color:white;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "Trading"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Manufacturing"))
